...
"[project]/.next-internal/server/app/api/session/get_session/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/session/get_session/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        const cookies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parse"])(req.headers.get("cookie") || "");
        ...
        const { session_id, user_tag, song_names } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$db_actions$2f$sessions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSession"])(browserSessionId ? browserSessionId : "");
        const session = browserSessionId ? session_id : null;
        if (!session) {
            throw new Error("Browser session not found in DB");
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            hasCookie: true,
            session,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__148ef905._.js.map