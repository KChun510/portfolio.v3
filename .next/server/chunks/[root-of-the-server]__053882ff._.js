...
"[project]/.next-internal/server/app/api/spotify/get_playlist/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
;
;
const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src/app/spotify_utils/token_data.json');
async function get_local_token() {
    const file_cont = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(filePath, 'utf8');
    return file_cont ? JSON.parse(file_cont) : null;
}
async function write_token_data(file_cont) {
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile('./token_data.json', JSON.stringify(file_cont), (err)=>{
        if (err) console.error("Error w to file: ", err);
    });
}
}}),
...
async function GET() {
    try {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$spotify_utils$2f$api_endpoints$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["get_playlist"])();
        if (!data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__053882ff._.js.map