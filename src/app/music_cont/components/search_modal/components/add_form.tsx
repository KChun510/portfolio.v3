...
const AddForm = ({ song_artists, song_cover_art, song_name, uri, backFnOnClick, closeModalFn, songData, refetch1, refetch2, refetch3, setSongAdded }: songPickModalProps) => {
	...
	return (
		<div className="text-white flex flex-col space-y-4 w-full">
			...
			<input
				type="text"
				id="small-input"
				className="block w-full p-2 border border-gray-600 rounded-lg text-base focus:ring-blue-500 focus:border-blue-500"
				placeholder="Put a Name to the Suggestion (Optional)"
				value={userTag}
				onKeyDown={(e) => handle_enter_press(e)}
				onChange={(e) => setUserTag(e.target.value)}
				style={{ backgroundColor: '#364153', color: '#fff' }}
			/>
